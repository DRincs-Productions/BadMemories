...
translate italian intro_day2_cb56ae6b:
    ...
    n "La porta si apre leggermente."
...
translate italian intro_day2_bb2cf764_1:
...
translate italian intro_day2_a27dcaa7:
    ...
    m "{size=-10}B-ma non sono sulla pillola, lo sapete!?{/size}"

# game/intro_day2.rpy:52
translate italian intro_day2_b3c1c44e:
...
translate italian intro_day2_bb2cf764_2:
...
translate italian intro_day2_528e81c9:
    ...
    m "Quindi, hai già un nuovo appartamento?"

# game/intro_day2.rpy:116
translate italian intro_day2_5a6ad07b:
...
translate italian intro_day2_eaef44ed:
...
translate italian intro_day2_2_1539e91a:
    ...
    n "Il momento in cui stai per partire, un uomo che sembra un manager si presenta e inizia a discutere con il receptionist."
...
translate italian intro_day2_2_0906f490:
    ...
    r "Mi dispiace, signore. È solo che il tecnico non ha ancora risolto l'AC ed è così caldo qui dentro."
...
translate italian intro_day2_2_44ee4b94:
    ...
    r "B-ma signore! Per favore, ho bisogno dei soldi, non puoi semplicemente buttarmi fuori!?"
