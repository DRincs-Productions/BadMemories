...
translate italian intro_942da871:
    ...
    n "Si dà al conducente il suo denaro e camminare verso il vostro nuovo appartamento, utilizzando alcune strade laterali che ancora ricordate dal passato."

# game/intro.rpy:33
translate italian intro_da8fa4e5:
...
translate italian intro_4f12e6ae:
    ...
    n "Mentre vai dietro l'angolo vedi l'edificio dove si trova il tuo prossimo appartamento in fiamme."

# game/intro.rpy:51
translate italian intro_9e568e0a:

    # n "You run towards the building, but a cop stops you."
    n "Corri verso l'edificio, ma un poliziotto ti ferma."
...
translate italian intro_d5ceade4:
    ...
    n "Gli dai il tuo documento d'identità e rispondi a molte domande stupide mentre l'ufficiale ti sta trattando come un gangster felice."
