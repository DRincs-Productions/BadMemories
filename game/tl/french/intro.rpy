...
translate french intro_942da871:
    ...
    n "Vous donnez son argent au chauffeur et vous vous dirigez vers votre nouvel appartement, en empruntant quelques routes secondaires dont vous vous souvenez encore du passé."

# game/intro.rpy:33
translate french intro_da8fa4e5:
...
translate french intro_4f12e6ae:
    ...
    n "En tournant le coin de la rue, vous voyez l'immeuble où se trouve votre futur appartement en flammes."

# game/intro.rpy:51
translate french intro_9e568e0a:

    # n "You run towards the building, but a cop stops you."
    n "Vous courez vers le bâtiment, mais un policier vous arrête."
...
translate french intro_d5ceade4:
    ...
    n "Vous lui donnez votre carte d'identité et répondez à un tas de questions stupides pendant que l'officier vous traite comme un gangster criminel."
